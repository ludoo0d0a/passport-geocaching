...
var urls = {
  request_token: {
    'staging'     : 'http://staging.geocaching.com/OAuth/oauth.ashx',
  ...
  api: {
    ...
    'live'       : 'https://api.groundspeak.com/Live/V6Beta/geocaching.svc/%s',
    'live_mobile' : 'https://api.groundspeak.com/Live/V6Beta/geocaching.svc/%s'
  }
}
...
function Strategy(options, verify) {
  ...
  options.consumerKey = options.consumerKey  || options.consumer_key;
  options.consumerSecret = options.consumerSecret  || options.consumer_secret;
