...
var urls = {
  ...
  api: {
    'staging': 'https://staging.api.groundspeak.com/%s',
    'prod': 'https://api.groundspeak.com/%s',
  }
}
 ...
 *                     (see https://confluence.atlassian.com/display/Geocaching/OAuth+on+Geocaching#OAuthonGeocaching-Scopes for more info)
 *
 * Examples:
 *
...
function Strategy(options, verify) {
  ...
  const url_base = urls[options.env];
  ...
  this._userProfileURL = options.userProfileURL || `${urls.api[options.env]}/v1/users/me`;
